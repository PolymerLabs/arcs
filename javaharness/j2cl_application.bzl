...
load("@com_google_j2cl//build_defs/internal_do_not_use:j2cl_js_common.bzl", "J2CL_OPTIMIZED_DEFS", "js_binary", "js_devserver", "simple_js_lib")

# This implementation has been copied from the Google J2CL repo and edited to enable
# ES6 mode, non-strict-mode, and suppression of some jscompiler diagnostic checks.
