...
public final class AndroidRuntimeSettingsImpl implements RuntimeSettings {
  ...
  private static final Logger logger = Logger.getLogger(
      AndroidRuntimeSettingsImpl.class.getName());
  ...
  abstract static class Settings {
    ...
    static Builder builder() {
      return new AutoValue_AndroidRuntimeSettingsImpl_Settings.Builder();
    }
  ...
  @Inject
  public AndroidRuntimeSettingsImpl() {
