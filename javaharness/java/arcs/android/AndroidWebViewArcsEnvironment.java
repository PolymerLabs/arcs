 ...
 */
@Singleton
final class AndroidWebViewArcsEnvironment implements AndroidArcsEnvironment {

  private static final Logger logger =
    Logger.getLogger(AndroidWebViewArcsEnvironment.class.getName());
