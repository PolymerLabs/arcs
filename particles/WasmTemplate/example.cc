#include <arcs.h>
#include <example-arcs.h>  // generated by schema2packager; filename is based on the manifest file

// C++ wasm builds are currently limited to a single source file per module, but they can
