...
public class ArcsRecipeDeclImpl extends ASTWrapperPsiElement implements ArcsRecipeDecl {

  public ArcsRecipeDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcsVisitor visitor) {
    visitor.visitRecipeDecl(this);
  }
