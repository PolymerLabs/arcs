...
public class ArcsHandleDeclImpl extends ASTWrapperPsiElement implements ArcsHandleDecl {

  public ArcsHandleDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcsVisitor visitor) {
    visitor.visitHandleDecl(this);
  }
