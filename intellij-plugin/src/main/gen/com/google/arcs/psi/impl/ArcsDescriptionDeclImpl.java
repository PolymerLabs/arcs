...
public class ArcsDescriptionDeclImpl extends ASTWrapperPsiElement implements ArcsDescriptionDecl {

  public ArcsDescriptionDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcsVisitor visitor) {
    visitor.visitDescriptionDecl(this);
  }
