...
public class ArcsStoreDeclImpl extends ASTWrapperPsiElement implements ArcsStoreDecl {

  public ArcsStoreDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcsVisitor visitor) {
    visitor.visitStoreDecl(this);
  }
