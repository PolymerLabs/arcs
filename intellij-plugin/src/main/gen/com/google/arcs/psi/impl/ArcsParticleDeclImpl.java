...
public class ArcsParticleDeclImpl extends ASTWrapperPsiElement implements ArcsParticleDecl {

  public ArcsParticleDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcsVisitor visitor) {
    visitor.visitParticleDecl(this);
  }
