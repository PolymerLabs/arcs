...
export class PECOuterPort extends APIPort {
  constructor(messagePort, arc) {
    ...
    this.registerHandler('ArcCreateSlot',
      {callback: this.Direct, arc: this.LocalMapped, transformationParticle: this.Mapped, transformationSlotName: this.Direct, hostedParticleName: this.Direct, hostedSlotName: this.Direct, storeId: this.Direct});
...
export class PECInnerPort extends APIPort {
  constructor(messagePort) {
    ...
    this.registerCall('ArcCreateSlot',
      {callback: this.LocalMapped, arc: this.Direct, transformationParticle: this.Mapped, transformationSlotName: this.Direct, hostedParticleName: this.Direct, hostedSlotName: this.Direct, storeId: this.Direct});
