...
class ParticleExecutionContext {
  ...
  // by `entityId` concerning `eventDetails. The `complete` flag indicates whether there are any further
  // events to be dispatched to the same particle.
  dispatch(particleId, entityId, eventDetails, complete) {
    throw 'unimplemented';
  }
