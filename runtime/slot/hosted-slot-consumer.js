...
export class HostedSlotConsumer extends Slot {
  constructor(arc, transformationSlotConsumer, hostedParticleName, hostedSlotName, hostedSlotId) {
    super(arc);
  ...
  set consumeConn(consumeConn) {
    ...
    if (this.transformationSlotConsumer.renderer.slotContext.container) {
      this.startRender();
    }
  }
  ...
  setContent(content) {
    this.renderCallback && this.renderCallback(
        ...
        this.hostedSlotId,
        this.transformationSlotConsumer.renderer.formatHostedContent(this, content));
  }

  constructRenderRequest() {
    return this.transformationSlotConsumer.renderer.constructRenderRequest(this);
  }
}
