...
describe('in-memory', function() {
  ...
  describe('variable', () => {
    ...
    it('supports pointer dereferences', async () => {
      ...
      let underlyingValue = await storage.storageInstances['in-memory']._typeMap.get(BarType).get('id1');
  ...
  describe('collection', () => {
    ...
    it('supports pointer dereferences', async () => {
      ...
      let underlyingValues = await storage.storageInstances['in-memory']._typeMap.get(BarType);
