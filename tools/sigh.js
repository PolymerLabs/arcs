...
function peg() {
  ...
  const source = peg.generate(readProjectFile(sources.peg.grammar), {
    ...
    tspegjs: {
      ...
      customHeader: `
// DO NOT EDIT, AUTOGENERATED from ${sources.peg.grammar}
import * as Token from '../../runtime/manifest-tokens.js';
`
    },
    returnTypes: {
      'Annotation': 'string',
      'BigCollectionType': 'Token.BigCollectionType',
      'CollectionType': 'Token.CollectionType',
      'ReferenceType': 'Token.ReferenceType',
      'VariableType': 'Token.VariableType',
      'VariableTypeList': 'Token.VariableType[]',
      'SlotType': 'Token.SlotType',
      'Direction': 'string',
      'Import': 'Token.Import',
      'LocalName': 'string',
      'Manifest': 'Token.ManifestItem[]',
      'ManifestItem': 'Token.ManifestItem',
      'ManifestStorage': 'Token.ManifestStorage',
      'ManifestDescription': 'Token.ManifestStorage',
      'ManifestStorageItem': 'string',
      'ManifestStorageSource': 'Token.ManifestStorageSource',
      'ManifestStorageFileSource': 'Token.ManifestStorageSource',
      'ManifestStorageResourceSource': 'Token.ManifestStorageSource',
      'ManifestStorageStorageSource': 'Token.ManifestStorageSource',
      'MetaItem': 'Token.MetaName|Token.MetaStorageKey',
      'MetaName': 'Token.MetaName',
      'MetaStorageKey': 'Token.MetaStorageKey',
      'ParticleAffordance': 'Token.ParticleAffordance',
      'ParticleArgument': 'Token.ParticleArgument',
      'ParticleArgumentDirection': 'string',
      'ParticleArgumentList': 'Token.ParticleArgument[]',
      'ParticleHandle': 'Token.ParticleArgument',
      'ParticleInterface': 'Token.ParticleInterface',
      'ParticleDefinition': 'Token.Particle',
      'Recipe': 'Token.Recipe',
      'RecipeHandle': 'Token.RecipeHandle',
      'RecipeParticle': 'Token.Particle',
      ...
      'Shape': 'Token.Shape',
      'ShapeItem': 'Token.ShapeInterface|Token.ShapeArgument|Token.ShapeSlot',
      'ShapeArgument': 'Token.ShapeArgument',
      'ShapeArgumentItem': 'Token.ShapeArgument',
      'ShapeArgumentList': 'Token.ShapeArgument[]',
      'ShapeArgumentWithName': 'Token.ShapeArgument',
      'ShapeInterface': 'Token.ShapeInterface',
      'ShapeSlot': 'Token.ShapeSlot',
      'SlotField': 'Token.SlotField',
      'Tag': 'string',
      'TagList': 'string[]',
