...
const cleanDirs = ['../shells/lib/build', '../build', '../dist', '../src/gen', '../test-output', '../user-test', coverageDir];
...
function cleanObsolete() {
    for (const file of [...findProjectFiles('builds', /javaharness|sigh\.js/, /\.(js|h|wasm)$/)]) {
        if (file.endsWith('.js')) {
