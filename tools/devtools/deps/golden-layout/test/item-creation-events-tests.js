/// BareSpecifier=golden-layout\test\item-creation-events-tests
describe('emits events when items are created', function () {

	var layout,
	    eventListener = window.jasmine.createSpyObj('eventListener', ['onItemCreated', 'onStackCreated', 'onComponentCreated', 'onRowCreated', 'onColumnCreated']);
