    ...
    val schema = newSchema(
      ...
      SchemaFields(
        singletons = mapOf(
          ...
          "durationlst" to FieldType.ListOf(FieldType.Duration),
        ...
        collections = mapOf(
          ...
          "durations" to FieldType.Duration,
    ...
    val entity = DatabaseData.Entity(
      RawEntity(
        ...
        mapOf(
          ...
          "duration" to ArcsDuration.ofMillis(10000001).toReferencable(),
          ...
          "durationlst" to listOf(
            ArcsDuration.ofMillis(1L),
            ArcsDuration.ofMillis(123456L),
            ArcsDuration.ofMillis(123123L)
          ).map {
            it.toReferencable()
          }.toReferencable(FieldType.ListOf(FieldType.Duration)),
        ...
        mapOf(
          ...
          "durations" to listOf(
            ArcsDuration.ofMillis(1000000000000000002L),
            ArcsDuration.ofMillis(1000000000000000003L)
          ).map { it.toReferencable() }.toSet(),
