...
class CollectionIntegrationTest {
    ...
    fun setUp() = runBlocking {
        ...
        collectionB = CollectionImpl("collectionB", SCHEMA_B, storageProxy, null, Ttl.Infinite, TimeImpl())
    ...
    fun addElementsWithTtls() = runBlockingTest {
        ...
        val collectionC = CollectionImpl("collectionC", SCHEMA_A, storageProxy, null, Ttl.Days(2), TimeImpl())
        ...
        val collectionD = CollectionImpl("collectionD", SCHEMA_B, storageProxy, null, Ttl.Minutes(1), TimeImpl())
