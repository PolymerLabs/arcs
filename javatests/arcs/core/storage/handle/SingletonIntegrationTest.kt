...
class SingletonIntegrationTest {
    ...
    fun setUp() = runBlocking {
        ...
        singletonA = SingletonImpl("singletonA", SCHEMA, storageProxy, null, Ttl.Infinite, TimeImpl())
        storageProxy.registerHandle(singletonA)
        singletonB = SingletonImpl("singletonB", SCHEMA, storageProxy, null, Ttl.Infinite, TimeImpl())
    ...
    fun addEntityWithTtl() = runBlockingTest {
        ...
        val singletonC = SingletonImpl("singletonC", SCHEMA, storageProxy, null, Ttl.Days(2), TimeImpl())
        ...
        val singletonD = SingletonImpl("singletonD", SCHEMA, storageProxy, null, Ttl.Minutes(1), TimeImpl())
