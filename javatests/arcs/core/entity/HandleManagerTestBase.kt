...
open class HandleManagerTestBase {
    ...
    data class Person(
        ...
        companion object : EntitySpec<Person> {
            ...
            private val queryByAge = CurrentScope<Number>(mutableMapOf())["age"] eq query("queryArgument")
            private val refinementAgeGtZero = CurrentScope<Number>(mutableMapOf())["age"] gt 0.asExpr()
