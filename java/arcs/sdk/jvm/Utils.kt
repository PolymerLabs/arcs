...
object Utils : UtilsInterface {
    ...
    override fun toUtf8String(bytes: ByteArray): String = bytes.toString(Charsets.UTF_8)

    override fun toUtf8ByteArray(str: String): ByteArray = str.toByteArray(Charsets.UTF_8)
}
