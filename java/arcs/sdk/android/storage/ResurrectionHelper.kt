...
class ResurrectionHelper(
    ...
    private val serviceClass: Class<out Service> = StorageService::class.java
) : arcs.core.host.ResurrectionHelper {
    /**
     ...
     */
    override fun cancelResurrectionRequest(targetId: String) {
        val intent = Intent(context, serviceClass)
