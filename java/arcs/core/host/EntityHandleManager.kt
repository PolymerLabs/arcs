 ...
 * [ReadSingleton] for [HandleMode.Read]. To obtain a [HandleHolder], use
...
internal open class ReadSingletonHandleImpl<T : Entity>(
    ...
    val sender: Sender
) : HandleEventBase<T?, ReadSingleton<T>>(), ReadSingleton<T> {
    init {
...
internal class ReadWriteSingletonHandleImpl<T : Entity>(
    ...
    WriteSingleton<T> by writableSingleton {
    override val name: String
...
internal open class ReadCollectionHandleImpl<T : Entity>(
    ...
    val sender: Sender
) : HandleEventBase<Set<T>, ReadCollection<T>>(), ReadCollection<T> {
    init {
...
internal class ReadWriteCollectionHandleImpl<T : Entity>(
    ...
    WriteCollection<T> by writableCollection {
    override val name: String
