...
abstract class AbstractArcHost(
    ...
    protected val updateArcHostContextCoroutineContext: CoroutineContext = Dispatchers.Default,
    ...
    init {
        ...
        /**
         * Asynchronous [ArcHostContext] serializations in a hot [Flow].
         * The [channel] will be cancelled when the [updateArcHostContextScope] is cancelled.
         */
        channel.consumeAsFlow()
            .onEach { it() }
            .launchIn(updateArcHostContextScope)
    }
    ...
    override suspend fun unpause() {
        ...
        /**
         * Wait until all [pausedArcs]s are started and/or resurrected and
         * their [ArcHostContext]s are serialized onto storage.
         */
        drainSerializations()
    }
    ...
    protected open suspend fun readContextFromStorage(
        ...
        // Ensure all serializations are flushed prior to (re)fetching any of them.
        drainSerializations()

        return createArcHostContextParticle(arcHostContext)
