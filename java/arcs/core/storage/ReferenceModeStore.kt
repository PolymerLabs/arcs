...
class ReferenceModeStore private constructor(
    ...
    init {
        ...
        containerStoreId = containerStore.on(ProxyCallback {
            receiveQueue.enqueue {
    ...
    override fun on(
        ...
        // Reference Mode Store must generate the callback token to ensure no duplicates.
        check(callbackToken == null) { "token must be generated by Reference Mode Store" }
