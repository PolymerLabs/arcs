package arcs.core.testutil.protoloader
...
/**
 * Loads a [ManifestProto] from a binary proto file (.binarypb). Use the `arcs_manifest_proto` BUILD
 * rule to generate the binary proto, and add that to the `data` deps for your test rule.
 *
 * @param path path to a binary proto file (.binarypb), relative to the repo root (e.g. starting with
 *     "javatests/")
 */
