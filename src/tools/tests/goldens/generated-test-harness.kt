...
class GoldTestHarness<P : AbstractGold>(
    ...
    HandleSpec("alias", HandleMode.ReadWrite, HandleContainerType.Singleton, Gold_Data_Ref, HandleDataType.Entity),
    ...
    val alias: ReadWriteSingletonHandle<Gold_Data_Ref> by handleMap
