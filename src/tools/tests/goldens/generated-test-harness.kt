...
class GoldTestHarness<P : AbstractGold>(
    ...
    HandleSpec("foo", HandleMode.ReadWrite, HandleContainerType.Singleton, Gold_Foo, HandleDataType.Entity)
)) {
    ...
    val foo: ReadWriteSingletonHandle<Gold_Foo> by handleMap
}
