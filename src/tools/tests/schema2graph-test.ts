...
describe('schema2graph', () => {
  it.only('creates nodes from every (particle, connection) combination', async () => {
      const manifest = await Manifest.parse(`
        particle Foo
          ...
          // diamond
          //in Data {Text a} hA
          //in Data {Text a, Text b} hB
          //in Data {Text a, Text c} hC
          //in Data {Text a, Text b, Text c} hD

          // extended diamond
          in Data {Text t} hA
          in Data {Text t, URL u} hB
          in Data {Text t, URL u, Number n} hC
          in Data {Text t, URL u, Boolean b} hD
          in Data {Text t, URL u, Text v} hE
          in Data {Text t, URL u, Number n, Boolean b, Text v} hF
          in Data {Text t, URL u, Number n, Boolean b, Text v, URL r} hG

          in Data {Text t, URL u, Number n} hC2
          in Data {Text t, URL u, Number n, Boolean b, Text v} hF2

          // mesh (+/- hE)
          //in Data {Text a} hA
          //in Data {Text b} hB
          //in Data {Text a, Text b, Text c} hC
          //in Data {Text a, Text b, Text d} hD
          //in Data {Text a, Text b, Text c, Text d} hE
        `);
  ...
  it('builds edges between handles according to the lattice constraints', async () => {
    ...
    assert.deepStrictEqual(graph.edges, {
      Foo_input1: ['Foo_output1'],
      Foo_input2: ['Foo_input1', 'Foo_output1', 'Foo_output2'],
      Foo_output1: [],
      Foo_output2: []
    });
  });
