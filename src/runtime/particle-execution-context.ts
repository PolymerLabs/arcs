...
import {ProxyCallback, ProxyMessage, StorageCommunicationEndpoint} from './storage/store-interface.js';
...
import {CRDTMuxEntity/*, TypeToCRDTTypeRecord, CRDTTypeRecordToType*/} from './storage/storage.js';
