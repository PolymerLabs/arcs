...
describe('suggestion', function() {
  ...
  it('deserialize empty', async () => {
    const suggestion1 =
        await Suggestion.deserialize({plan: 'recipe', hash: '123', rank: 1});
    assert.isTrue(Boolean(suggestion1.plan));
    const suggestion2 =
        await Suggestion.deserialize({plan: 'recipe', hash: '123', rank: 1, versionByStore: '{}', searchGroups: [], descriptionByModality: {}}, {}, {});
