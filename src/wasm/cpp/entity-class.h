...
//
// particle Test
//   in * {Number num, Text txt, URL lnk, Boolean flg, Reference<* {Text a}> ref} data
...
public:
  ...
  void set_a(const std::string& value) { a_ = value; a_valid_ = true; }
  void clear_a() { a_ = ""; a_valid_ = false; }
  bool has_a() const { return a_valid_; }
