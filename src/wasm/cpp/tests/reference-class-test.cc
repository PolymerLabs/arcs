...
static auto converter() {
  return [](const arcs::Ref<arcs::Dummy_data>& r) { return arcs::entity_to_str(r); };
}
...
public:
  ...
  void test_accessor_methods() {
    ...
    arcs::Ref<arcs::Dummy_data> r2 = arcs::clone_entity(r1);
    ...
    arcs::Ref<arcs::Dummy_data> r3 = r1;
  ...
  void test_empty_references() {
    ...
    EQUAL(r1.entity(), arcs::Dummy_data());
  ...
  void test_populated_references() {
    ...
    arcs::Dummy_data* d1 = const_cast<arcs::Dummy_data*>(&r1.entity());
    d1->set_lnk("zelda");
  ...
  void test_operators() {
    TestHandle handle;
    arcs::Ref<arcs::Dummy_data> r1(&handle);
    arcs::Ref<arcs::Dummy_data> r2(&handle);
  ...
  void test_stl_set() {
    ...
    std::set<arcs::Ref<arcs::Dummy_data>> s = {r1, r2, r3, r4};
    std::vector<std::string> expected = {
      "REF<>",
  ...
  void test_stl_unordered_set() {
    ...
    std::unordered_set<arcs::Ref<arcs::Dummy_data>> s = {r1, r2, r3, r4};
    std::vector<std::string> expected = {
      "REF<>",
