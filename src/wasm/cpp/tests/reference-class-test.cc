...
static auto converter() {
  return [](const arcs::Ref<Test_data>& r) { return arcs::entity_to_str(r); };
}
...
public:
  ...
  void test_accessor_methods() {
    ...
    arcs::Ref<Test_data> r2 = arcs::clone_entity(r1);
  ...
  void test_populated_references() {
    ...
    Test_data* d1 = const_cast<Test_data*>(&r1.entity());
    d1->set_lnk("zelda");
  ...
  void test_stl_set() {
    ...
    std::set<arcs::Ref<Test_data>> s = {r1, r2, r3, r4};
    std::vector<std::string> expected = {
      "REF<>",
  ...
  void test_stl_unordered_set() {
    ...
    std::unordered_set<arcs::Ref<Test_data>> s = {r1, r2, r3, r4};
    std::vector<std::string> expected = {
      "REF<>",
