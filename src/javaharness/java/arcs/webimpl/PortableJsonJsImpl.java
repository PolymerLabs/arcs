...
public class PortableJsonJsImpl implements PortableJson {
  ...
  private static native Object eval(String js);
  ...
  private boolean isEqual(PortableJsonJsImpl other) {
    Equator equator =
        (Equator)
            eval(
                "(obj, other) => { let compare = (o1, o2) => { return Object.keys(o1).length == Object.keys(o2).length && Object.keys(o1).every(key => (!!o1[key] == !!o2[key]) || ((o1[key] instanceof Object) && (o2[key] instanceof Object) && compare(o1[key]), o2[key])); }; return compare(obj, other); }");
