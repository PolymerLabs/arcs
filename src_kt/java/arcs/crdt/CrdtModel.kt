...
interface CrdtModel<Data : CrdtData, Op : CrdtOperation, ConsumerData> {
  ...
  /**
   * Merges the [other] [CrdtModel] into this one returning the changes invoked on this [CrdtModel]
   * as well as the changes required to be invoked on the [other] one.
   *
   * Example:
   * ```kotlin
