...
class StringEncoderTest {
  ...
  fun encodeList() {
    ...
    val expectedString = "3:D27:2:4:nameT4:Jill3:ageT4:70.0D27:2:4:nameT4:Jack3:ageT4:25.0D26:2:4:nameT3:Jen3:ageT4:50.0"
    assertThat(encodedString).isEqualTo(expectedString)
  }
  ...
  fun encodeEntity() {
    ...
    val expectedString = "A94:3:D27:2:4:nameT4:Jill3:ageT4:70.0D27:2:4:nameT4:Jack3:ageT4:25.0D26:2:4:nameT3:Jen3:ageT4:50.0"
    assertThat(encodedString).isEqualTo(expectedString)
  }
}
